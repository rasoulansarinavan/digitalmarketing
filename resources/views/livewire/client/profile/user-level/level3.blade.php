    ...
    @else
        <form wire:submit.prevent="submitLevel3(Object.fromEntries(new FormData($event.target)))">
            <div class="row gutters">
                ...
                <div class="mb-10 basis-full xl:basis-2/3"><h3
                        class="mb-5 font-Pelak text-sm font-semibold text-primary">
                        راهنمای گرفتن عکس سلفی</h3>
                    <ul class="font-Estedad text-xs font-semibold leading-7 text-gray-700 xl:pl-20">
                        <li class="mb-2 flex items-start">
                            <svg class="ml-3 mt-1 min-w-[18px] text-gray-600 " xmlns="http://www.w3.org/2000/svg"
                                 width="18"
                        ...
                        <li class="mb-2 flex items-start">
                            ...
                            از اضافه و یا کم کردن لغتی از متن سلفی جدا خودداری نموده و متن را به درستی یادداشت
                            نمایید(اگر
                            متن
                ...
                <div class="flex flex-wrap items-start justify-center py-10 md:justify-between xl:flex-nowrap">
                    <div class="flex basis-full flex-col xl:basis-2/3"><h3
                        ...
                        <div
                            class="mb-10 font-Estedad text-xs font-semibold leading-7 text-gray-700 xl:pl-20 undefined">
                            <p>
                                ...
                                سواستفاده از حساب دیگران را دارند پس اطلاعات حساب بانکی و اکانت ایرانیکارت خود را در
                                اختیار
                                کسی
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <!-- Field wrapper start -->
                    <div class="field-wrapper">
                        <input name="serial" class="form-control @error('serial') error-input-border @enderror"
                               id="serial"
